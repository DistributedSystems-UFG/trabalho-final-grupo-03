-- =============================================================
--  SCD Inventory — seed.sql
--  Executado pelo Gerente de BD (principal) na primeira inicialização.
--  Cada ReplicaAgent executa uma cópia idêntica deste arquivo para
--  criar a mesma ESTRUTURA de tabelas antes de receber writes via
--  replicação — os DADOS chegam pela replicação, não pelo seed.
-- =============================================================
